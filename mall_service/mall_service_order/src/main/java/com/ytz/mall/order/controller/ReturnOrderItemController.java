...
import com.ytz.mall.order.pojo.ReturnOrderItem;
import com.ytz.mall.order.service.ReturnOrderItemService;
...
public class ReturnOrderItemController {
    ...
    public Result<List<ReturnOrderItem>> findList(@RequestBody(required = false)  ReturnOrderItem returnOrderItem){
        ...
        return new Result<List<ReturnOrderItem>>(true,StatusCode.SUCCESS,"查询成功",list);
    }
    ...
    public Result<ReturnOrderItem> findById(@PathVariable Long id){
        ...
        return new Result<ReturnOrderItem>(true,StatusCode.SUCCESS,"查询成功",returnOrderItem);
    }
