...
public class OrderConfigController {
    ...
    public Result<List<OrderConfig>> findList(@RequestBody(required = false)  OrderConfig orderConfig){
        ...
        return new Result<List<OrderConfig>>(true,StatusCode.SUCCESS,"查询成功",list);
    }
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  OrderConfig orderConfig,@PathVariable Long id){
        //设置主键值
    ...
    public Result<OrderConfig> findById(@PathVariable Integer id){
        ...
        return new Result<OrderConfig>(true,StatusCode.SUCCESS,"查询成功",orderConfig);
    }
