...
import com.ytz.mall.order.service.UndoLogService;
...
public class UndoLogController {
    ...
    public Result<List<UndoLog>> findList(@RequestBody(required = false)  UndoLog undoLog){
        ...
        return new Result<List<UndoLog>>(true,StatusCode.SUCCESS,"查询成功",list);
    }
    ...
    public Result<UndoLog> findById(@PathVariable Long id){
        ...
        return new Result<UndoLog>(true,StatusCode.SUCCESS,"查询成功",undoLog);
    }
