...
import com.ytz.mall.order.pojo.ReturnCause;
import com.ytz.mall.order.service.ReturnCauseService;
...
public class ReturnCauseController {
    ...
    public Result<PageInfo> findPage(@PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<PageInfo>(true,StatusCode.SUCCESS,"查询成功",pageInfo);
    }
    ...
    public Result<List<ReturnCause>> findList(@RequestBody(required = false)  ReturnCause returnCause){
        ...
        return new Result<List<ReturnCause>>(true,StatusCode.SUCCESS,"查询成功",list);
    }
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  ReturnCause returnCause,@PathVariable Long id){
        //设置主键值
    ...
    public Result<ReturnCause> findById(@PathVariable Integer id){
        ...
        return new Result<ReturnCause>(true,StatusCode.SUCCESS,"查询成功",returnCause);
    }
