...
import com.ytz.mall.order.pojo.ReturnOrder;
import com.ytz.mall.order.service.ReturnOrderService;
...
public class ReturnOrderController {
    ...
    public Result<List<ReturnOrder>> findList(@RequestBody(required = false)  ReturnOrder returnOrder){
        ...
        return new Result<List<ReturnOrder>>(true,StatusCode.SUCCESS,"查询成功",list);
    }
    ...
    public Result<ReturnOrder> findById(@PathVariable Long id){
        ...
        return new Result<ReturnOrder>(true,StatusCode.SUCCESS,"查询成功",returnOrder);
    }
