...
import com.ytz.mall.order.service.OrderLogService;
...
public class OrderLogController {
    ...
    public Result<List<OrderLog>> findList(@RequestBody(required = false)  OrderLog orderLog){
        ...
        return new Result<List<OrderLog>>(true,StatusCode.SUCCESS,"查询成功",list);
    }
    ...
    public Result<OrderLog> findById(@PathVariable String id){
        ...
        return new Result<OrderLog>(true,StatusCode.SUCCESS,"查询成功",orderLog);
    }
