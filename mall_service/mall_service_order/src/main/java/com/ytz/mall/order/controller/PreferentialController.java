...
public class PreferentialController {
    ...
    public Result<List<Preferential>> findList(@RequestBody(required = false)  Preferential preferential){
        ...
        return new Result<List<Preferential>>(true,StatusCode.SUCCESS,"查询成功",list);
    }
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  Preferential preferential,@PathVariable Long id){
        //设置主键值
    ...
    public Result<Preferential> findById(@PathVariable Integer id){
        ...
        return new Result<Preferential>(true,StatusCode.SUCCESS,"查询成功",preferential);
    }
