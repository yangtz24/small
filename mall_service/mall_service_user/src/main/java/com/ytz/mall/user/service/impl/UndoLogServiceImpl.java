...
import com.ytz.mall.user.dao.UndoLogMapper;
...
public class UndoLogServiceImpl implements UndoLogService {
     ...
     */
    @Override
    public int update(UndoLog undoLog){
        return undoLogMapper.updateByPrimaryKey(undoLog);
    }
     ...
     */
    @Override
    public int add(UndoLog undoLog){
        return undoLogMapper.insert(undoLog);
    }
