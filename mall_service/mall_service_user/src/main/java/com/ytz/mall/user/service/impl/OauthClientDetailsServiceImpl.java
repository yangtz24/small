...
import com.ytz.mall.user.dao.OauthClientDetailsMapper;
...
public class OauthClientDetailsServiceImpl implements OauthClientDetailsService {
    ...
    public PageInfo<OauthClientDetails> findPage(OauthClientDetails oauthClientDetails, int page, int size){
        ...
        //执行搜索
        return new PageInfo<>(oauthClientDetailsMapper.selectByExample(example));
    }
    ...
    public PageInfo<OauthClientDetails> findPage(int page, int size){
        ...
        PageHelper.startPage(page,size);
        //分页查询
        return new PageInfo<>(oauthClientDetailsMapper.selectAll());
    }
     ...
     */
    @Override
    public int update(OauthClientDetails oauthClientDetails){
     ...
     */
    @Override
    public int add(OauthClientDetails oauthClientDetails){
